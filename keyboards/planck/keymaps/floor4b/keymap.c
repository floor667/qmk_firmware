...
[_COLE] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, LT(_EDIT,KC_TAB), KC_LALT, LALT_T(KC_SPACE), KC_F23, KC_BSPC, KC_BSPC, KC_RCTL, KC_RALT, XXXXXXX, XXXXXXX
),
...
[_NUM] = LAYOUT_planck_grid(
    ...
    _______, _______, KC_LCTL, _______, _______, _______, _______, _______,  KC_P0, KC_DOT, _______, _______
),
...
const uint16_t PROGMEM jk_combo[] = {KC_Y, KC_SCOLON, COMBO_END};
