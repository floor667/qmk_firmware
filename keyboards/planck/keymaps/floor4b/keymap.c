...
[_COLE] = LAYOUT_planck_grid(
    ...
    KC_Z,  LT(_MIDI,KC_X), LSFT_T(KC_C),  LT(_NUM,KC_V),  LT(_SYM,KC_B), KC_ALLK, LT(_SYM,KC_K), LT(_NUM,KC_M),  RSFT_T(KC_COMM), KC_DOT, KC_SLSH, KC_ENTER,
    XXXXXXX, XXXXXXX, LT(_EDIT,KC_TAB), KC_LALT, KC_SPACE, KC_BSPC, KC_NO, KC_RCTL, KC_RALT, XXXXXXX, XXXXXXX, XXXXXXX
),

[_NUM] = LAYOUT_planck_grid(
    _______, _______, _______, _______, _______, DBL_BRC, DBL_PAR, KC_P7, KC_P8,  KC_P9, KC_NLCK, _______,
     SC_SCTAB, SC_SCQ, SC_VIS, SC_VIW, SC_VIQ, DBL_QUO, KC_EQUAL, KC_P4, KC_P5, KC_P6, KC_MINS, _______,
    SC_GCL, SC_GRE, SC_GON, SC_GTB, SC_GNX, DBL_SQR,  KC_LBRC,  KC_P1, KC_P2,  KC_P3, KC_RBRC, _______,
    _______, _______, KC_LCTL, _______, _______, _______, _______,  KC_P0, KC_DOT, _______, _______, _______
),
