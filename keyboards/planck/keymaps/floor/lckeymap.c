...
[_SYM] = LAYOUT_planck_grid(
    ...
    LCTL_T(KC_ESC), LALT_T(KC_F5), KC_F6, KC_F7, KC_F8, _______, DBL_DQT, KC_DLR, KC_PERC, KC_CIRC, TD(TD_ALTUND), TD(TD_CTLPLUS),
...
[_MIDI] = LAYOUT_planck_grid(
    MI_OCTU, MI_As,  MI_B,  MI_C_1,  MI_Cs_1, MI_D_1, MI_Ds_1, MI_E_1, MI_F_1,  MI_Fs_1, MI_G_1,  MIDI,
    MI_OCTD,   MI_F,   MI_Fs, MI_G,    MI_Gs,   MI_A,   MI_As,   MI_B,   MI_C_1,  MI_Cs_1, MI_D_1,  MI_TRNSU,
    MI_SUS,   MI_C,   MI_Cs, MI_D,    MI_Ds,   MI_E,   MI_F,    MI_Fs,  MI_G,    MI_Gs,   MI_A,    MI_TRNSD,
    KC_NO, KC_NO, MI_CHD, MI_CHU,  MI_SOFT, MI_SOFT, MI_SUS,  MI_SUS, MI_ALLOFF,   MI_VELD, MI_VELU, MI_TRNS_0
)
