...
[_COLE] = LAYOUT_planck_grid(
    ...
    KC_A,  KC_R,  KC_S,  KC_T,  KC_D, LT(_EDIT, KC_TAB), KC_DNEN,  KC_H,  KC_N,  KC_E,  KC_I, KC_O, 
    KC_Z,  KC_X,  KC_C,  KC_V,  KC_B, KC_LCAP, KC_GUCA, KC_K,  KC_M,  KC_COMM, KC_DOT, KC_SLSH,
    XXXXXXX, XXXXXXX, LALT_T(KC_ESC), XXXXXXX, LSFT_T(KC_SPACE), KC_LYEN, KC_LYEN, RSFT_T(KC_BSPC), XXXXXXX, RCTL_T(KC_QUOTE), XXXXXXX, XXXXXXX
),
...
[_NUM] = LAYOUT_planck_grid(
    ...
    _______, _______, KC_LCTL, _______, MO(_SYM), _______, _______, MO(_SYM), _______, KC_RALT, _______, _______
),
...
[_EDIT] = LAYOUT_planck_grid(
    RESET, KC_MS_U, KC_VOLD, KC_VOLU, _______, EEP_RST, _______, KC_WH_L, MO_UL, MO_UR, KC_WH_R, KC_WH_U,
...
#ifdef AUDIO_ENABLE
   float beep[][2]    = SONG(ZELDA_TREASURE);
   float enter[][2]    = SONG(TERM_SOUND);
   float homeb[][2]    = SONG(ZELDA_STORMS);
   float endb[][2]    = SONG(ZELDA_STREV);
