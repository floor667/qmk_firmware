...
[_COLE] = LAYOUT_planck_grid(
    ...
    KC_Z,  KC_X,  LCTL_T(KC_C),  LALT_T(KC_V),  LSFT_T(KC_B), KC_ALLK, KC_GUCA, RSFT_T(KC_K),  RALT_T(KC_M),  RCTL_T(KC_COMM), KC_DOT, KC_SLSH,
    XXXXXXX, XXXXXXX, LT(_EDIT,KC_TAB), KC_ESC, LT(_NUM,KC_SPACE), KC_ENTER, LT(_SYM,KC_BSPC), LT(_SYM,KC_BSPC), KC_QUOT, KC_BSLS, XXXXXXX, XXXXXXX
),
...
//    case KC_K:
//      return alternate_modifier(KC_LALT, KC_BSPC, record);
    case KC_GRV:
