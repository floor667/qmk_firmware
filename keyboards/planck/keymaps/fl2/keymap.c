...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    MO(_MSE), KC_RCTL, NAMS, KC_LAYR, SPSH, SPSH, KC_NO, KC_LAYR, MODF, KC_LCTL, KC_LALT, KC_NO
  ),
...
[_NUM] = LAYOUT(
    ...
    _______, _______, KC_TRNS, _______,  KC_NO, KC_0, KC_0, KC_TRNS,  KC_TRNS, _______, _______, TO(_SYM)
  ),
...
[_SYM] = LAYOUT(
    ...
    KC_NO, KC_NO, OSM(MOD_LALT), KC_TRNS, KC_NO, S(KC_0), S(KC_0), KC_TRNS,  KC_TRNS, KC_NO, KC_NO, TO(_NUM)
),
...
[_MSE] = LAYOUT(
    KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO, LOK, KC_WH_L, MO_UL, MO_UR, KC_WH_R, KC_WH_U, KC_NO,
    ...
    KC_NO, WORD, WORDT, _______, KC_NO, KC_NO,       MO_DC, MO_DL, MO_DR, KC_NO, KC_BTN3, KC_NO,
      _______, KC_NO, KC_NO, _______, KC_NO, KC_BTN1, KC_BTN1, KC_BTN2, KC_NO, KC_NO, KC_NO, KC_NO
),
};
