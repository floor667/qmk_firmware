...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_COLE] = { /* COLEMAK */
  ...
  { MO(_EDIT), KC_LCTL, KC_LALT, KC_LGUI, KC_LSS, KC_NO, KC_NO, TG(_EDIT), KC_NO, KC_NO, KC_LES, MODF, KC_LEFT, KC_DOWN, KC_RGHT  },
 },
...
[_EDIT] = { /* MOUSE */
  ...
  { _______, _______, _______, _______, _______, _______, _______, _______, KC_VOLU, _______, MO_UL, MO_UR, _______, KC_WH_U, KC_HOME  },
  { RGB_TOG, RGB_RMOD, RGB_MOD, RGB_SAD, RGB_SAI, _______, _______, _______, KC_VOLD, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_WH_D, KC_PGUP  },
  { _______, RGB_HUD, RGB_HUI, RGB_VAD, RGB_VAI, _______, _______, _______, _______, MO_DC, MO_DL,  MO_DR,  KC_BTN2, KC_BTN3, KC_PGDN  },
