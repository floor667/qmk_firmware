...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_COLE] = { /* COLEMAK */
  ...
  { KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,  KC_1,   KC_2   KC_3, KC_K,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_UP, KC_GRV  },
 ...
 [_MOV] = { /* FUNCTION */
  ...
  { _______, _______,  SC_VIW, SC_VIQ,   _______, _______, _______, DBL_PAR, KC_ESC, KC_NO, KC_NO,  KC_UPHO,  KC_DEL, DBL_GRV  },
  { _______, _______, _______, _______, _______, _______, _______, DBL_SQR,  KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_DNEN, DBL_QUO, _______ },
  { _______, _______, _______, _______, KC_NO, KC_NO, _______, DBL_ANG,  KC_TAB,  KC_VOLD, KC_VOLU,  KC_LBRC,  KC_RBRC,  _______, KC_CAPS },
