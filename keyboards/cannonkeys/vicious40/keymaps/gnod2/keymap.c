...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_QW] = { /* QWERTY */
  { KC_ESC,  TH_F1,    TH_F2,    TH_F3,    TH_F4,    TH_F5,   TH_F6,    TH_F7,    TH_F8,    TH_F9,    TH_F10, TH_F11,  TH_F12, KC_NHUS,  KC_HOME  },
  { KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,   KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC,  KC_RBRC,  KC_BSPC, KC_PGUP  },
  { KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT, KC_ENT, KC_PGDN   },
  { KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_NUBS, KC_UP, KC_END  },
