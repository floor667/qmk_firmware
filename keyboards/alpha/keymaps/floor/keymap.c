...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[HOME] = LAYOUT(
		...
		LT(MSE,KC_Z), MT(MOD_LALT,KC_X), LT(NUM,KC_C), LT(NAV,KC_V), KC_SPC, LT(NUM,KC_K), MT(MOD_RCTL,KC_N), MT(MOD_RALT,KC_B)),

	[NAV] = LAYOUT(
		RESET, KC_NO, KC_HOME, KC_INS, KC_UPHO, KC_QUOT, KC_TAB, KC_GRV, KC_BSLS, KC_ESC,
		KC_LSFT, KC_NO, KC_END, KC_DEL, KC_DNEN, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_ENT,
		KC_LCTL, KC_LALT, LM(NUM,MOD_LSFT), _______, KC_BSPC, KC_COMM, KC_DOT, KC_SLSH),

	[NUM] = LAYOUT(
		SC_GCL, SC_GRE, SC_GON, SC_GTB, SC_GNX, DBL_SQR, KC_7, KC_8, KC_9, KC_0,
		KC_LSFT, KC_NO, SC_VIW, SC_VIS, SC_VIQ, KC_EQUAL, KC_4, KC_5, KC_6, KC_MINS,
